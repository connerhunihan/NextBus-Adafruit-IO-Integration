...
ADAFRUIT_IO_KEY      = 'ee35d91c3f6c403da3645325d4589dd7'
ADAFRUIT_IO_USERNAME = 'connerhunihan'  # See https://accounts.adafruit.com
...
def connected(client):
    ...
    print('Connected to Adafruit IO!  Listening for NextBus updates...')
    # Subscribe to changes on a feed named DemoFeed.
    client.subscribe('NextBus')
...
print('Publishing a new message every 60 seconds (press Ctrl-C to quit)...')
while True:
    value = nextArrival()
    print('Publishing {0} to NextBus.'.format(value))
    client.publish('NextBus', value)
    time.sleep(60)
